...
<div class="home_body_div" align=center>
	...
	<div>
		<img id="topBanner" src ="${pageContext.request.contextPath}/resources/images/cat01_64.png" title="서울기술교육센터" >
	</div>
	...
	<form name="loginForm" method="post" class="loginForm" onsubmit="loginCheck()">
     ...
     <c:if test="${member == null}">
     	...
     	<div class="bottomText">사용자가 아니면 ▶<a id="hypertext" href="/member/mbrInfoRegister" 
