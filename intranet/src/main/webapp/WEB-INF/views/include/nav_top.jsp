...
&nbsp;&nbsp; <a id="hypertext" href="/member/mbrInfoList" onMouseover="this.style.background='pink'; this.style.textDecoration='underline';" 
onmouseout="this.style.background='white'; this.style.textDecoration='none';">사용자정보</a>&nbsp;&nbsp; | &nbsp;&nbsp;
</c:if>
<c:if test="${authority_code != '01'}">
&nbsp;&nbsp; <a id="hypertext" href="/member/mbrInfoView" onMouseover="this.style.background='pink'; this.style.textDecoration='underline';" 
onmouseout="this.style.background='white'; this.style.textDecoration='none';">사용자정보</a>&nbsp;&nbsp; | &nbsp;&nbsp;
</c:if>
...
<a id="hypertext" href="/edu/eduView" onMouseover="this.style.background='pink'; this.style.textDecoration='underline';" 
onmouseout="this.style.background='white'; this.style.textDecoration='none';">강의</a> &nbsp;&nbsp; | &nbsp;&nbsp;

<a id="hypertext" href="/schedule/sourceView" onMouseover="this.style.background='pink'; this.style.textDecoration='underline';" 
