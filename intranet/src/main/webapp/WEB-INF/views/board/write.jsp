...
function register(){
	...
	if(content_files.length == 0) $("#registerForm").attr("action", "/board/write").submit();
...
function sendFileToServer()
{
	...
	var uploadURL = "/board/fileUpload?kinds=R"; 
...
//        	if(JSON.parse(data)['result'] == "OK"){
        		setProgress(100);
   	    		alert("파일업로드 성공");
   	    		$("#registerForm").attr("action", "/board/write").submit();
