...
<body>
   ...
   <div class="menubar">
    ...
    <div class="mainView"><%-- ${pageContext.request.contextPath}/video/1.mp4 --%>
        <div class="videoView">
        <!-- <video width="940" src="https://www.youtube.com/embed/nNdj0cE1BSw"   -->
            <video width="940" src="../${pageContext.request.contextPath}video/1.mp4"
                controls autoplay muted controlsList="nodownload">브라우저가 후져서 지원이 안되네요.</video>
                <!-- <iframe width="940" height="520" src="https://www.youtube.com/embed/nNdj0cE1BSw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
