...
function loginCheck(){
    ...
    document.loginForm.action = '/Intranet/login';
...
<div class="home_body_div" align=center>
	...
	<form name="loginForm" method="post" class="loginForm" onsubmit="loginCheck()">
     ...
     <c:if test="${member == null}">
     	...
     	<div class="bottomText">사용자가 아니면 ▶<a id="hypertext" href="/Intranet/mbrInfoRegister" 
		...
		<div class="bottomText">▶<a id="hypertext" href="/Intranet/idFind" 
     	       onMouseover="this.style.background='pink'; this.style.textDecoration='underline';" 
     	       onmouseout="this.style.background='white'; this.style.textDecoration='none';">아이디 찾기</a><br><br></div>
     </c:if>
