...
<a id="hypertext" href="/board/mbrInfoModify" onMouseover="this.style.background='pink'; this.style.textDecoration='underline';" 
onmouseout="this.style.background='white'; this.style.textDecoration='none';">사용자 정보 수정</a>&nbsp&nbsp | &nbsp&nbsp
<a id="hypertext" href="/board/passwdModify" onMouseover="this.style.background='pink'; this.style.textDecoration='underline';" 
