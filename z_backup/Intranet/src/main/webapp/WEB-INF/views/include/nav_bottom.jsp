...
[&nbsp;&nbsp;
<a id="hypertext" href="/Intranet/view?bno=${viewPrev}&num=${view.num}" onMouseover="this.style.background='pink'; this.style.textDecoration='underline';" 
onmouseout="this.style.background='white'; this.style.textDecoration='none';">이전글</a> &nbsp;&nbsp;| &nbsp;&nbsp;

<a id="hypertext" href="/Intranet/modify?bno=${view.bno}&num=${view.num}" onMouseover="this.style.background='pink'; this.style.textDecoration='underline';" 
...
<a id="hypertext" href="/Intranet/view?bno=${viewNext}&num=${view.num}" onMouseover="this.style.background='pink'; this.style.textDecoration='underline';" 
